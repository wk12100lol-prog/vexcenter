...
$friend = Database::fetch("SELECT id, username FROM users WHERE id = ?", [$friendId]);
...
Database::insert("INSERT INTO notifications (user_id, type, message) VALUES (?, 'friend_request', ?)", [$friendId, $user['username'] . ' wysłał Ci zaproszenie do znajomych']);
