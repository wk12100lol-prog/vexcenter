    ...
    this.el.innerHTML = `
      <nav class="sidebar-nav">
        <div class="sidebar-section">
          <div class="sidebar-section-title" data-i18n="browse_section">Przeglądaj</div>
          <a class="sidebar-item active" data-route="store" href="#">
            ...
            <span data-i18n="store">Sklep</span>
          </a>
          <a class="sidebar-item" data-route="library" href="#">
            ...
            <span data-i18n="library">Biblioteka</span>
          </a>
        </div>
        <div class="sidebar-section">
          <div class="sidebar-section-title" data-i18n="community">Społeczność</div>
        ...
        <div class="sidebar-section" data-role="admin">
          <div class="sidebar-section-title" data-i18n="admin">Administracja</div>
          <a class="sidebar-item" data-route="admin" href="#">
            ...
            <span data-i18n="admin_panel">Panel Admina</span>
          </a>
        </div>
